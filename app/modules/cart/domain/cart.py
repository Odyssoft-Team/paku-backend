...
class CartRepository(Protocol):
    ...
    def add_items(self, cart_id: UUID, user_id: UUID, items: list[CartItem]) -> list[CartItem]:
        ...

    def replace_all_items(self, cart_id: UUID, user_id: UUID, items: list[CartItem]) -> list[CartItem]:
        ...
