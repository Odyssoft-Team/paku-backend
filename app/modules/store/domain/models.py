...
class StoreRepository(Protocol):
    ...
    async def create_product(self, *, category_id: UUID, name: str, description: Optional[str], species: Species, allowed_breeds: Optional[List[str]], is_active: bool, included_items: Optional[List[str]] = None) -> Product: ...
