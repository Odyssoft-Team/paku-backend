...
class StoreRepository(Protocol):
    ...
    async def create_product(self, *, category_id: UUID, name: str, species: Species, allowed_breeds: Optional[List[str]], is_active: bool) -> Product: ...
    ...
    async def create_addon(self, *, product_id: UUID, name: str, species: Species, allowed_breeds: Optional[List[str]], is_active: bool) -> Addon: ...
